...
import { Search, User, Settings, FileText, Bookmark, LogOut, ChevronDown } from "lucide-react"
      ...
      <div className="container flex h-16 items-center justify-between">
        ...
        <div className="hidden md:flex flex-1 max-w-md mx-8">
          <div className="relative flex-1">
            ...
            <Input
              placeholder="Search datasets, methods, or topics..."
              className="pl-10 bg-white/10 border-white/20 text-white placeholder:text-white/60 focus:bg-white focus:text-spin-navy focus:placeholder:text-gray-500"
            />
          </div>
        </div>
